...
def test_example_b(monkeypatch, capsys):
    monkeypatch.setattr(fileinput, 'input', open("test/fixtures/example_b_input.txt").readlines)
    main()
    captured = capsys.readouterr()
...
def test_example_c(monkeypatch, capsys):
    monkeypatch.setattr(fileinput, 'input', open("test/fixtures/example_c_input.txt").readlines)
    main()
    captured = capsys.readouterr()
